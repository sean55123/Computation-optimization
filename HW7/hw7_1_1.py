...
# 8) C balance
def balance_C(model):
    return model.C == model.convBtoC_ii*model.bII + model.convBtoC_iii*model.bIII
...
print(f"{model.C.value:.3f} ton/hr amount of C is produced")
